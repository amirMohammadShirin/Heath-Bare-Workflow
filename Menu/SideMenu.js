...
export default class SideMenu extends Component {
    ...
    generateFullName() {
        ...
        this.setState({ fullName: fullName, user: userInfo, baseUrl: firstParam['baseUrl'], imageObject: image })
    }
            ...
            <Container>
                <View style={{ height: '20%', width: '100%', backgroundColor: '#23b9b9' }}>
                    <ImageBackground style={styles.headerImage}
                        // source={require(
                        //     'D:\\Adrian Jobs\\Heath-Bare-Workflow-master\\Heath-Bare-Workflow-master\\assets\\images\\BACK.png')
                            source={require(
                                    ...
                                    {this.state.user != null ? <View>
                                        {this.state.user.gender !== 'زن' ?
                                            ...
                                            <Thumbnail large circular style={{
                                                ...
                                                //         veil
                                                // }}
                                                source={{ uri: (this.state.user.Image !== null && typeof this.state.user.Image !== 'undefined') ? 'data:image/png;base64,' + this.state.user.Image : this.state.imageObject.veil }}
                    ...
                    <List>
                        ...
                        {this.getAccess('notice', 'admin') &&
                            <ListItem icon style={styles.listItem} onPress={() => {
                                this.props.navigation.navigate('InfoScreen', {
                                    baseUrl: this.state.baseUrl != null ? this.state.baseUrl : 'empty', imageObject: this.state.imageObject
                                })
                            }}>
                                <Right>
                        ...
                        {this.getAccess('searchDoctor', 'admin') &&
                            <ListItem icon style={styles.listItem} onPress={() => {
                                ...
                                this.props.navigation.navigate('SearchDoctorScreen', { medicalCenter: '', imageObject: this.state.imageObject })
                            }}>
                                <Right>
