    ...
    return (
        <Card style={[styles.post]}>
            ...
            <CardItem style={{backgroundColor: props.myColor, flexDirection: 'row-reverse'}}>
                ...
                <Body>
                    <Text style={styles.value}>{props.actor}</Text>
                </Body>
            </CardItem>
            <CardItem style={{backgroundColor: props.myColor, flexDirection: 'row-reverse'}}>
                <Right>
                ...
                <Body>
                    <Text style={styles.value}>{props.medicalCenter}</Text>
                </Body>
            </CardItem>
            <CardItem style={{backgroundColor: props.myColor, flexDirection: 'row-reverse'}}>
                <Right>
...
export default class ShowReservesScreen extends Component {
    ...
    renderList(value, index) {
        if (value.statusValue === '8' || value.statusValue === '1' || value.status === 'لغو شده' || value.status ===
            'لغو حضور توسط مراجعه کننده') {
            return (
                <View key={index}>
                    <Swipeable>
