...
const SEARCHDOCTORALLFIELD = '/SearchDoctorAllField';
const GETFAVORITEDOCTORS = '/GetFavoriteDoctors';
const SEARCHALLFIELDOFDOCTOROFSPECIFICMEDICALCENTER =
    '/SearchAllFieldOfDoctorOfSpecificMedicalCenter';
export default class SearchMedicalCenter extends Component {
    ...
    async search(text) {
        ...
        if ((await this.state.selectedMedicalCenter) != null) {
            ...
            let Body = {
                Method: "POST",
                Url: SEARCHALLFIELDOFDOCTOROFSPECIFICMEDICALCENTER,
                username: '',
                nationalCode: '',
                body: {
                    SearchWord: text,
